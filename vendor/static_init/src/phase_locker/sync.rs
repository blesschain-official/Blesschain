...
#[allow(dead_code)] // the second field is used by drop
...
//-------------------
//
impl<T> Deref for SyncPhaseGuard<'_, T> {
    type Target = T;
    #[inline(always)]
    fn deref(&self) -> &T {
        self.0
...
impl<T> Phased for SyncPhaseGuard<'_, T> {
    #[inline(always)]
...
//-------------------
//
impl<T> Deref for SyncReadPhaseGuard<'_, T> {
    type Target = T;
    #[inline(always)]
    fn deref(&self) -> &T {
        self.0
...
impl<T> Phased for SyncReadPhaseGuard<'_, T> {
    #[inline(always)]
    fn phase(this: &Self) -> Phase {
        this.1.init_phase
    }
...
impl<T> Clone for SyncReadPhaseGuard<'_, T> {
    fn clone(&self) -> Self {
...
impl<'a> Lock<'a> {
    ...
    #[inline(always)]
    #[allow(dead_code)] // used by other impl
...
impl SyncPhaseLocker {
    ...
    pub fn lock_mut<'a, T: ?Sized>(&'a mut self, v: &'a T) -> SyncPhaseGuard<'a, T> {
